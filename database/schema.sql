...
CREATE TABLE IF NOT EXISTS file_metadata(
    ...
    CONSTRAINT file_metadata_id_pk PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS users(
    ...
    CONSTRAINT user_pfp_file_id_fk FOREIGN KEY (pfp_file_id) REFERENCES file_metadata(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS phone_numbers(
    ...
    CONSTRAINT phone_number_user_id_fk FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS students(
    ...
    CONSTRAINT student_user_id_fk FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT student_enrollment_proof_file_id_fk FOREIGN KEY (enrollment_proof_file_id) REFERENCES file_metadata(id),
...
CREATE TABLE IF NOT EXISTS documents(
    ...
    CONSTRAINT documents_file_id_fk FOREIGN KEY (file_id) REFERENCES file_metadata(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS accommodation_tags(
    ...
    CONSTRAINT accommodation_tags_id_pk PRIMARY KEY (id),
    CONSTRAINT accommodation_tags_accommodation_id_fk FOREIGN KEY (accommodation_id) REFERENCES accommodations(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS accommodation_images(
    ...
    CONSTRAINT accommodation_images_id_pk PRIMARY KEY (id),
    CONSTRAINT accommodation_images_accommodation_id_fk FOREIGN KEY (accommodation_id) REFERENCES accommodations(id) ON DELETE CASCADE,
    CONSTRAINT accommodation_images_image_file_id_fk FOREIGN KEY (image_file_id) REFERENCES file_metadata(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS reviews(
    ...
    CONSTRAINT review_student_number_fk FOREIGN KEY (student_number) REFERENCES students(student_number) ON DELETE CASCADE,
    CONSTRAINT review_accommodation_id_fk FOREIGN KEY (accommodation_id) REFERENCES accommodations(id) ON DELETE CASCADE 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS bookmarks(
    ...
    CONSTRAINT bookmark_student_number_fk FOREIGN KEY (student_number) REFERENCES students(student_number) ON DELETE CASCADE,
    CONSTRAINT bookmark_accommodation_id_fk FOREIGN KEY (accommodation_id) REFERENCES accommodations(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS assignments(
    ...
    CONSTRAINT assignment_room_id_fk FOREIGN KEY (room_id) REFERENCES rooms(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS payments(
    ...
    CONSTRAINT payment_proof_file_id_fk FOREIGN KEY (proof_file_id) REFERENCES file_metadata(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS sys_variables(
    ...
    CONSTRAINT sys_variables_id_pk PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
AUTO_INCREMENT = 1;
