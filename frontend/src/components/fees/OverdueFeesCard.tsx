...
interface OverdueFeesCardProps {
    tenants: Tenant[];
    isLoading: boolean;
    isError: boolean;
...
export default function OverdueFeesCard({ tenants, isLoading, isError, onView }: OverdueFeesCardProps) {
    ...
    // Reset to page 1 when search or tenants change
            ...
            <div className="px-5 py-4 border-b border-[#6B0F2B]/10">
                <div className="flex justify-between items-start">
                    <div className="flex flex-col">
                        <h2 className="text-lg font-bold text-[#6B0F2B]">Overdue Fees</h2>
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col justify-center items-center h-full py-12 text-center">
                        {searchQuery ? (
                            ...
                            <>
                                <p className="text-gray-500 font-medium text-lg">No overdue fees.</p>
                                <p className="text-gray-400 text-sm mt-1">All tenants are up to date.</p>
                            </>
                        )}
                    </div>
                ) : (
                                ...
                                {paginatedTenants.map((tenant) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className='px-3 py-3'>
                                                <span className="block text-[12px] lg:text-[14px] text-gray-800">
                                                    {dueDate.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                                                </span>
                                                <span className="block text-[10px] lg:text-[12px] text-red-500">
