                ...
                <div className="bg-white border border-[#E8D0D8] rounded-xl p-3 lg:p-4 shadow-sm w-full h-full flex flex-col">
                    ...
                    <div className="overflow-y-auto -mx-0">
                        <div className="min-w-[780px] pb-3 lg:pb-0">
                            ...
                            >
                                <p className="col-span-1 text-[#9A7080] text-xs font-bold py-1">Student</p>
                                <p className="col-span-1 text-[#9A7080] text-xs font-bold py-1">Room</p>
                                <p className="col-span-1 text-[#9A7080] text-xs font-bold py-1">Room Type</p>
                                <p className="col-span-1 text-[#9A7080] text-xs font-bold py-1">Date</p>
                                <p className="col-span-1 text-center text-[#9A7080] text-xs font-bold py-1">Type</p>
                                <p className="col-span-1 text-center text-[#9A7080] text-xs font-bold py-1">Action</p>
                            </div>
                            {data.length > 0 ? (
                                <div className="flex flex-col">
                                    {data.map((move: Move, i: number) => (
                                        ...
                                        >
                                            ...
                                            <p className="col-span-1 text-[#1A0008] text-sm flex items-center">{move.date}</p>
