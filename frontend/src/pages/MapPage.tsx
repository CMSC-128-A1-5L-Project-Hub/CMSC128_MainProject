  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', fontFamily: "'Segoe UI', sans-serif", overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative', height: '100%' }}>
        ...
        <div className="md:hidden flex items-center h-[70px] px-6 bg-white border-b border-gray-100 z-[550] shrink-0">
          <h1 className="text-[26px] font-serif italic text-[#710A2B] ml-10"> <b> Map View </b></h1>
        </div>
