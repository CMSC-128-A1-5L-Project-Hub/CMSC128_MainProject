        ...
        <div className="bg-[#F5EEF0] h-screen overflow-hidden flex flex-col">
            <div className='flex flex-row justify-start items-center mt-3'>
                ...
                <div className="flex flex-col justify-left gap-[1px]">
                    <h1 className='font-serif font-bold italic text-[28.5px] lg:text-[31px] text-[#6B0F2B] px-5 lg:p-0 leading-tight -mt-2'>Billing Dashboard</h1>
                    <p className="text-[#9A7080] text-[13px] px-5 leading-tight -mt-1">{currentResidence}     •     {currentAY}</p>
                </div>
            </div>
