  ...
  <div className="flex flex-col gap-1">
    ...
    <div className="relative">
      <select
        ...
        className="appearance-none border border-gray-200 rounded-xl px-3 py-2 pr-8 text-sm font-semibold focus:outline-none focus:border-[#6B0F2B] cursor-pointer bg-white"
        style={{ color: CLR.mid }}
      >
        {options.map((o) => (
    ...
    <div className="flex min-h-screen bg-[#F6F2F4]">
      ...
      <main className="flex-1 p-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
          <div className="flex flex-wrap justify-between items-end gap-3 p-4 border-b">
            <div>
              <h2 className="text-lg font-semibold tracking-tight" color="black">
                Application History
              </h2>
            ...
            <div className="flex flex-wrap items-end gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-[#6B0F2B] min-w-[220px]"
                />
              </div>
            </div>
          </div>
                  ...
                  paginated.map((app) => {
                    ...
                    return (
                      <tr key={`${app.id}-${startIndex}`} className="border-t hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{app.date}</td>
