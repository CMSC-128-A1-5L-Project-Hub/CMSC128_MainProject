        ...
        {activeTab === "Application" ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
            ...
            <div className="w-full flex justify-end gap-3">
                ...
                <>
                    <button className="px-4 py-2 rounded-xl bg-red-100 text-red-700">
                    Reject
                    </button>
                ...
                <button className="px-4 py-2 rounded-xl bg-[#8C1535] text-white">
                    Save
                </button>
                ) : selectedApp?.status === "Accepted" ? (
                <button className="px-4 py-2 rounded-xl bg-[#8C1535] text-white">
  ...
  <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-x-6 gap-y-4 text-[13px]">
        ...
        <div className="space-y-1">
          ...
          <div className="flex gap-2 mt-1">
            <button className="text-[11px] px-3 py-1 rounded-full bg-[#F5ECF0] border border-[#6B0F2B]/20">
              FORM 5
            </button>
            <button className="text-[11px] px-3 py-1 rounded-full bg-[#F5ECF0] border border-[#6B0F2B]/20">
              VALID ID
    ...
    {selectedApp.status === "Under Review" && (
      <textarea
        ...
        className="w-full h-[70px] border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#6B0F2B]"
      />
    )}
          ...
          <div className="space-y-2">
            ...
            {["Room 210", "Room 221"].map((room) => (
              ...
              >
                ...
                <button className="text-[11px] px-3 py-1 rounded-full bg-[#8C1535] text-white">
                  Assign
                </button>
              </div>
            ))}
      ...
      <div className="space-y-3">
        ...
        <div className="border rounded-2xl p-4">
          ...
          <div className="flex items-center justify-between border rounded-xl px-3 py-2">
            <div>
              <p className="text-sm font-medium">Room 210</p>
              <p className="text-[10px] text-gray-400">
                Building 2
              </p>
            </div>

            <span className="text-[11px] px-3 py-1 rounded-full bg-green-100 text-green-700">
              Assigned
            </span>
          </div>
        </div>
