    ...
    export default class AssignmentSeeder extends BaseSeeder {
        async run() {
            ...
            */
            ...
            // Update status of full rooms
            for (const roomId of Object.keys(roomOccupancyDelta)) {
                await db
                    .from("rooms")
                    .where("id", roomId)
                    .whereRaw("room_current_occupancy >= room_capacity")
                    .update({ room_availability: "occupied"});
            }
...
>>>>>>> 977ccc3a18a5ea57725ffb23cd05d945d00453de
