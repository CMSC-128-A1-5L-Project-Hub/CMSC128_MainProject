  ...
  async run() {
    ...
    if (await isTableEmpty('applications')) {
      await db.table('applications').multiInsert([
        ...
        { accommodation_id: getAccom('ATI-NTC Residence Hall'), student_number: '2023-123457', application_room_type: 'shared', application_stay_type: 'non_transient', application_status: 'under_review', duration_of_stay_days: 30, application_date: '2026-02-20 14:00:00', reviewed_at: null, reviewed_by: null, room_id: getRoom('402', 'ATI-NTC Residence Hall'), move_in_date: '2026-03-05', move_out_date: '2026-04-04', reservation_fee: 500.0, move_in_fee: 800.0 },
        ...
        { accommodation_id: getAccom('ATI-NTC Residence Hall'), student_number: '2023-123458', application_room_type: 'shared', application_stay_type: 'transient', application_status: 'under_review', duration_of_stay_days: 30, room_id: getRoom('402', 'ATI-NTC Residence Hall'), move_in_date: '2026-04-05', move_out_date: '2026-05-05', reservation_fee: 500.0, move_in_fee: 800.0 },
        ...
        { accommodation_id: getAccom('ATI-NTC Residence Hall'), student_number: '2023-123459', application_room_type: 'shared', application_stay_type: 'non_transient', application_status: 'cancelled', duration_of_stay_days: 200, room_id: getRoom('402', 'ATI-NTC Residence Hall'), move_in_date: null, move_out_date: null, reservation_fee: null, move_in_fee: null },
        ...
        { accommodation_id: getAccom('ATI-NTC Residence Hall'), student_number: '2023-123461', application_room_type: 'shared', application_stay_type: 'non_transient', application_status: 'cancelled', duration_of_stay_days: 200, room_id: getRoom('401', 'ATI-NTC Residence Hall'), move_in_date: null, move_out_date: null, reservation_fee: null, move_in_fee: null },
        { accommodation_id: getAccom('One Sapphire Place'), student_number: '2023-123457', application_room_type: 'single', application_stay_type: 'transient', application_status: 'pending', duration_of_stay_days: 45, room_id: getRoom('601', 'One Sapphire Place'), move_in_date: '2026-04-10', move_out_date: '2026-05-25', reservation_fee: 1000.0, move_in_fee: 9000.0 },
        { accommodation_id: getAccom('ATI-NTC Residence Hall'), student_number: '2023-123457', application_room_type: 'shared', application_stay_type: 'transient', application_status: 'approved', duration_of_stay_days: 90, room_id: getRoom('401', 'ATI-NTC Residence Hall'), move_in_date: '2026-03-10', move_out_date: '2026-06-08', reservation_fee: 500.0, move_in_fee: 800.0 },
      ])
    }
    ...
    if (await isTableEmpty('bookmarks')) {
      await db.table('bookmarks').multiInsert([
        ...
        { student_number: '2023-123457', accommodation_id: getAccom('ATI-NTC Residence Hall') },
      ])
    }
